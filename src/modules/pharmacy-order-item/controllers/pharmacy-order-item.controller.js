...
const getPharmacyOrderItemById = asyncHandler(async (req, res) => {
  const { id } = req.params;
  const pharmacyOrderItem = await pharmacyOrderItemService.getPharmacyOrderItemById(id, req.user?.id, req.ip);
...
const createPharmacyOrderItem = asyncHandler(async (req, res) => {
  const pharmacyOrderItem = await pharmacyOrderItemService.createPharmacyOrderItem(req.body, req.user?.id, req.ip);
...
const updatePharmacyOrderItem = asyncHandler(async (req, res) => {
  const { id } = req.params;
  const pharmacyOrderItem = await pharmacyOrderItemService.updatePharmacyOrderItem(id, req.body, req.user?.id, req.ip);
...
const deletePharmacyOrderItem = asyncHandler(async (req, res) => {
  const { id } = req.params;
  await pharmacyOrderItemService.deletePharmacyOrderItem(id, req.user?.id, req.ip);
  sendNoContent(res);
});
