 ...
 *
 * @module modules/analytics-event/repositories
 * @description Data access layer for analytics event operations.
 ...
 * @returns {Promise<Object|null>} Analytics event object or null
 */
...
/**
 * Find many analytics events with pagination
 *
...
/**
 * Count analytics events with filters
 *
 * @param {Object} filters - Filter criteria
 * @returns {Promise<number>} Count of analytics events
 */
const count = async (filters = {}) => {
  try {
    ...
    return await prisma.analytics_event.count({ where });
  } catch (error) {
    throw new HttpError('errors.database.unexpected', 500, [{ originalError: error.message }]);
  }
};
...
/**
 * Soft delete analytics event
 * Per prisma.mdc: Only soft deletes allowed
 *
 * @param {string} id - Analytics event ID
 * @returns {Promise<Object>} Deleted analytics event
 */
