...
const getHousekeepingTaskById = asyncHandler(async (req, res) => {
  ...
  const housekeepingTask = await housekeepingTaskService.getHousekeepingTaskById(id);
...
const createHousekeepingTask = asyncHandler(async (req, res) => {
  ...
  const housekeepingTask = await housekeepingTaskService.createHousekeepingTask(data, context);
...
const updateHousekeepingTask = asyncHandler(async (req, res) => {
  ...
  const housekeepingTask = await housekeepingTaskService.updateHousekeepingTask(id, data, context);
...
const deleteHousekeepingTask = asyncHandler(async (req, res) => {
  ...
  await housekeepingTaskService.deleteHousekeepingTask(id, context);
