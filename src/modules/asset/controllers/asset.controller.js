...
const getAssetById = asyncHandler(async (req, res) => {
  ...
  const asset = await assetService.getAssetById(id, userId, ipAddress);
...
const createAsset = asyncHandler(async (req, res) => {
  ...
  const asset = await assetService.createAsset(req.body, userId, ipAddress);
...
const updateAsset = asyncHandler(async (req, res) => {
  ...
  const asset = await assetService.updateAsset(id, req.body, userId, ipAddress);
...
const deleteAsset = asyncHandler(async (req, res) => {
  ...
  await assetService.deleteAsset(id, userId, ipAddress);
