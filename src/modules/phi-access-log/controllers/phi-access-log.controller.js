...
const getPhiAccessLogById = asyncHandler(async (req, res) => {
  const { id } = req.params;
  const phiAccessLog = await phiAccessLogService.getPhiAccessLogById(id);
...
const createPhiAccessLog = asyncHandler(async (req, res) => {
  ...
  const phiAccessLog = await phiAccessLogService.createPhiAccessLog(data, userId, ipAddress);
...
const updatePhiAccessLog = asyncHandler(async (req, res) => {
  ...
  const phiAccessLog = await phiAccessLogService.updatePhiAccessLog(id, data, userId, ipAddress);
...
const deletePhiAccessLog = asyncHandler(async (req, res) => {
  ...
  await phiAccessLogService.deletePhiAccessLog(id, userId, ipAddress);
