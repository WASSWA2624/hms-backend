...
const subscriptionInvoiceService = require('../services/subscription-invoice.service');
...
const getSubscriptionInvoice = async (req, res) => {
  const { id } = req.params;
  const subscriptionInvoice = await subscriptionInvoiceService.getSubscriptionInvoiceById(id);
