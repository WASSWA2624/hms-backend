...
const inventoryStockService = require('../services/inventory-stock.service');
...
const getInventoryStockById = asyncHandler(async (req, res) => {
  ...
  const inventoryStock = await inventoryStockService.getInventoryStockById(id, userId, ipAddress);
...
const createInventoryStock = asyncHandler(async (req, res) => {
  ...
  const inventoryStock = await inventoryStockService.createInventoryStock(req.body, userId, ipAddress);
...
const updateInventoryStock = asyncHandler(async (req, res) => {
  ...
  const inventoryStock = await inventoryStockService.updateInventoryStock(id, req.body, userId, ipAddress);
...
const deleteInventoryStock = asyncHandler(async (req, res) => {
  ...
  await inventoryStockService.deleteInventoryStock(id, userId, ipAddress);
