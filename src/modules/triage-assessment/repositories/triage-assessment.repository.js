...
const SEARCHABLE_TRIAGE_LEVELS = new Set(['IMMEDIATE', 'URGENT', 'LESS_URGENT', 'NON_URGENT']);
...
const buildWhere = (filters = {}) => {
  ...
  if (SEARCHABLE_TRIAGE_LEVELS.has(searchUpper)) {
    searchClauses.push({ triage_level: searchUpper });
  }
