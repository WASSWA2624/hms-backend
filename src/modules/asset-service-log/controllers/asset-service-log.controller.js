...
const assetServiceLogService = require('../services/asset-service-log.service');
...
const getAssetServiceLogById = asyncHandler(async (req, res) => {
  ...
  const assetServiceLog = await assetServiceLogService.getAssetServiceLogById(id, userId, ipAddress);
...
const createAssetServiceLog = asyncHandler(async (req, res) => {
  ...
  const assetServiceLog = await assetServiceLogService.createAssetServiceLog(req.body, userId, ipAddress);
...
const updateAssetServiceLog = asyncHandler(async (req, res) => {
  ...
  const assetServiceLog = await assetServiceLogService.updateAssetServiceLog(id, req.body, userId, ipAddress);
...
const deleteAssetServiceLog = asyncHandler(async (req, res) => {
  ...
  await assetServiceLogService.deleteAssetServiceLog(id, userId, ipAddress);
