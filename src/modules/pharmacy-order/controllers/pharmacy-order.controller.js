...
const getPharmacyOrderById = asyncHandler(async (req, res) => {
  ...
  const pharmacyOrder = await pharmacyOrderService.getPharmacyOrderById(id, userId, ipAddress);
...
const createPharmacyOrder = asyncHandler(async (req, res) => {
  ...
  const pharmacyOrder = await pharmacyOrderService.createPharmacyOrder(req.body, userId, ipAddress);
...
const updatePharmacyOrder = asyncHandler(async (req, res) => {
  ...
  const pharmacyOrder = await pharmacyOrderService.updatePharmacyOrder(id, req.body, userId, ipAddress);
...
const deletePharmacyOrder = asyncHandler(async (req, res) => {
  ...
  await pharmacyOrderService.deletePharmacyOrder(id, userId, ipAddress);
