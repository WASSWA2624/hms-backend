...
const getHousekeepingScheduleById = asyncHandler(async (req, res) => {
  ...
  const housekeepingSchedule = await housekeepingScheduleService.getHousekeepingScheduleById(id);
...
const createHousekeepingSchedule = asyncHandler(async (req, res) => {
  ...
  const housekeepingSchedule = await housekeepingScheduleService.createHousekeepingSchedule(data, context);
...
const updateHousekeepingSchedule = asyncHandler(async (req, res) => {
  ...
  const housekeepingSchedule = await housekeepingScheduleService.updateHousekeepingSchedule(id, data, context);
...
const deleteHousekeepingSchedule = asyncHandler(async (req, res) => {
  ...
  await housekeepingScheduleService.deleteHousekeepingSchedule(id, context);
