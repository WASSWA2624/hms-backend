...
const equipmentRegistryController = require('../controllers/equipment-registry.controller');
const { validateRequest } = require('@middlewares/validate.middleware');
const { authenticate } = require('@middlewares/auth.middleware');
const { createEquipmentRegistrySchema, updateEquipmentRegistrySchema, equipmentRegistryIdParamsSchema, listEquipmentRegistrysQuerySchema } = require('../schemas/equipment-registry.schema');
