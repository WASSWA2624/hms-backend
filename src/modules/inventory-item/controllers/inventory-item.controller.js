...
const getInventoryItemById = asyncHandler(async (req, res) => {
  ...
  const inventoryItem = await inventoryItemService.getInventoryItemById(id, userId, ipAddress);
...
const createInventoryItem = asyncHandler(async (req, res) => {
  ...
  const inventoryItem = await inventoryItemService.createInventoryItem(req.body, userId, ipAddress);
...
const updateInventoryItem = asyncHandler(async (req, res) => {
  ...
  const inventoryItem = await inventoryItemService.updateInventoryItem(id, req.body, userId, ipAddress);
...
const deleteInventoryItem = asyncHandler(async (req, res) => {
  ...
  await inventoryItemService.deleteInventoryItem(id, userId, ipAddress);
