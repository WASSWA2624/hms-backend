...
const getDrugById = asyncHandler(async (req, res) => {
  ...
  const drug = await drugService.getDrugById(id, userId, ipAddress);
...
const createDrug = asyncHandler(async (req, res) => {
  ...
  const drug = await drugService.createDrug(req.body, userId, ipAddress);
...
const updateDrug = asyncHandler(async (req, res) => {
  ...
  const drug = await drugService.updateDrug(id, req.body, userId, ipAddress);
...
const deleteDrug = asyncHandler(async (req, res) => {
  ...
  await drugService.deleteDrug(id, userId, ipAddress);
