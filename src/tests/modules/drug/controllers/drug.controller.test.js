...
describe('Drug Controller', () => {
  ...
  describe('getDrugById', () => {
    it('should call service and send success response', async () => {
      ...
      expect(drugService.getDrugById).toHaveBeenCalledWith('123', 'user-123', '127.0.0.1');
  ...
  describe('createDrug', () => {
    it('should call service and send success response', async () => {
      ...
      expect(drugService.createDrug).toHaveBeenCalledWith(mockData, 'user-123', '127.0.0.1');
  ...
  describe('updateDrug', () => {
    it('should call service and send success response', async () => {
      ...
      expect(drugService.updateDrug).toHaveBeenCalledWith('123', updateData, 'user-123', '127.0.0.1');
  ...
  describe('deleteDrug', () => {
    it('should call service and send no content response', async () => {
      ...
      expect(drugService.deleteDrug).toHaveBeenCalledWith('123', 'user-123', '127.0.0.1');
