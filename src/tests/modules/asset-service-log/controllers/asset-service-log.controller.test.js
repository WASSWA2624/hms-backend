...
describe('Asset Service Log Controller', () => {
  ...
  describe('getAssetServiceLogById', () => {
    it('should get asset service log by ID', async () => {
      ...
      expect(assetServiceLogService.getAssetServiceLogById).toHaveBeenCalledWith('1', 'user-123', '127.0.0.1');
  ...
  describe('deleteAssetServiceLog', () => {
    it('should delete asset service log', async () => {
      ...
      expect(assetServiceLogService.deleteAssetServiceLog).toHaveBeenCalledWith('1', 'user-123', '127.0.0.1');
