...
describe('Inventory Item Controller', () => {
  ...
  describe('getInventoryItemById', () => {
    it('should call service and send success response', async () => {
      ...
      expect(inventoryItemService.getInventoryItemById).toHaveBeenCalledWith('123', 'user-123', '127.0.0.1');
  ...
  describe('createInventoryItem', () => {
    it('should call service and send success response', async () => {
      ...
      expect(inventoryItemService.createInventoryItem).toHaveBeenCalledWith(mockReq.body, 'user-123', '127.0.0.1');
      expect(sendSuccess).toHaveBeenCalledWith(
        mockRes,
        201,
  ...
  describe('updateInventoryItem', () => {
    it('should call service and send success response', async () => {
      ...
      expect(inventoryItemService.updateInventoryItem).toHaveBeenCalledWith('123', mockReq.body, 'user-123', '127.0.0.1');
      expect(sendSuccess).toHaveBeenCalledWith(
        mockRes,
        200,
  ...
  describe('deleteInventoryItem', () => {
    it('should call service and send no content response', async () => {
      ...
      expect(inventoryItemService.deleteInventoryItem).toHaveBeenCalledWith('123', 'user-123', '127.0.0.1');
