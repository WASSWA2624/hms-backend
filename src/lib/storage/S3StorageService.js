 ...
 * Per storage.mdc: S3StorageService implements StorageService interface
 * 
...
const createS3StorageService = (config) => {
  ...
  const initializeClient = () => {
    try {
      const { S3Client, PutObjectCommand: Put, DeleteObjectCommand: Delete, GetObjectCommand: Get, HeadObjectCommand: Head } = require('@aws-sdk/client-s3');
